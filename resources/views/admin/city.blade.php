                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <select name="province" id="select_province" class="form-control" placeholder="pilih provinsi">
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <select name="city" id="select_city" class="form-control" disabled placeholder="pilih kota">
