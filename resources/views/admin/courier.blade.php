...
<html lang="en" >
    ...
    <body id="kt_body" class="header-fixed subheader-enabled page-loading">
		                ...
		                <div class="main d-flex flex-column flex-row-fluid">
		                    <div class="content flex-column-fluid">
                                <div class="col-lg-12">
                                    ...
                                    <div class="card-header">
                                        <div class="card-title">
                                            <h3 class="card-label">Tambah data kurir</h3>
                                        </div>
                                    </div>
                                        <div class="card-body">
                                            <form action="" id="form_courier" method="post">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <select name="courier" id="select_courier" class="form-control">
                                ...
                                <div class="col-lg-12 mt-5">
                                    ...
                                    <div class="card-header">
                                        <div class="card-title">
                                            <h3 class="card-label">Data kurir</h3>
                                        </div>
                                    </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table id="courier-table" class="display table table-striped table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Kode</th>
        ...
        <script src="/adm/js/courier.js"></script>
    </body>
</html>
